  ...
  return (
    <Container className='au-page-container'>
      ...
      <Container id='about-us-container'>
        <h1 className='center'><strong>About Us</strong></h1>
      ...
      <Row>
        <Col>
          ...
          <h5>
            Join us at Wags ‘n’ Wings, where your pet's happiness, comfort, and well-being are at the heart of everything we do.
          </h5>
        </Col>
      </Row>
    </Container>
