  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <strong>We also have accommodations for dogs who are not socialized, please inquire for pricing and details.</strong>
        </li>
      </ul>
      <p>
        Dogs that are boarding must adhere to all daycare policies.
        Click <a href='/daycare'>here</a> to view Daycare policies.
      </p>
    </>
  );
}

export default DogPolicies;
